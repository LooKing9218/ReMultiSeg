...
def vis_multi_class(imt, ant, pred, save_dir,n_class=3,is_boundary=True):      #输入N*H*W，输出路径/result/data_path/eval/fusion/vis
                                                                               #拼接图片从左至右 原图、预测、金标准
...
def gray2rgbimage(image):                                                      #单通道变三通道，方便后续的彩色图片拼接
    a,b = image.shape
